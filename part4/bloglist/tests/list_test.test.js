...
describe('favourite blog', () => {
  ...
  test('null input, return null', () => {
    const result = listHelper.favoriteBlog(null)
    expect(result).toBe(null)
  })

  test('one blog, return the blog', () => {
  ...
  test('multiple blogs, return the most liked blog', () => {
...
describe('most blogs', () => {
  ...
  test('multiple blogs, return author with most blog', () => {
